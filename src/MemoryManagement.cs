...
// This code was copied from the libpalaso repository since we don't want the overhead of actually using
// any of those assemblies just to report memory use for developer debugging.
using System;
...
//			Debug.Write("DEBUG: " + message);
			...
			{
				s_warningShown = true;
				var warning = "Unfortunately, {0} is starting to get short of memory, and may soon slow down or experience other problems. We recommend that you quit and restart it when convenient.";
				var caption = "Warning";
				MessageBox.Show(null, string.Format(warning, Application.ProductName), caption, MessageBoxButtons.OK, MessageBoxIcon.Warning);
			}
			return danger;
		}
